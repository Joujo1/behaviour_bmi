...
# on AUDIO_PINS["left"] or AUDIO_PINS["right"] (see config.py for BCM pin
# assignments). The ItsyBitsy M4 detects the RISING edge and immediately
# starts playing its pre-baked 192 kHz waveform from its onboard DAC.
